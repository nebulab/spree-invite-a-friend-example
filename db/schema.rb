...
ActiveRecord::Schema.define(version: 20140725103057) do
  ...
  add_index "spree_users", ["invitation_token"], name: "index_spree_users_on_invitation_token", unique: true
  add_index "spree_users", ["invitations_count"], name: "index_spree_users_on_invitations_count"
  add_index "spree_users", ["invited_by_id"], name: "index_spree_users_on_invited_by_id"
